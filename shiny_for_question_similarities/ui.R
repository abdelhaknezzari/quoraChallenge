    ...
    fluidRow(
      ...
      tabItem(tabName = "FEAT_ENG_HOW",
               box(width = "100%",
                   ...
                   box(title = "Similariy Matix",plotOutput("SIMILARITY_MATRIX_PLOT"))),
                   box( title = "Features Calculation",
                       # box( title = "Words Statistics",DT::dataTableOutput('FEAT1_TABLE') ),
                       # box( title = "Gramatical Entity Statistics",DT::dataTableOutput('FEAT2_TABLE') ),
